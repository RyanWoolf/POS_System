  ...
  return (
    <div className="flex drop-shadow-lg">
      ...
      <div id="content-container">
        <div className="w-[calc(100vw-226px)] absolute z-100 top-0 flex p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
